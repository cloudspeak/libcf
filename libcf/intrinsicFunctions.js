module.exports = {
    ...
    Fn: {
         ...
         */
        Join: function(delimiter, listOfValues) {
            return {
         ...
         */
        Select: function(index, listOfObjects) {
            return {
         ...
         */
        Split: function(delimiter, sourceString) {
            return { "Fn::Split":
         ...
         */
        Sub: function(string, variableMap) {
            if (variableMap) {
                return {
         ...
         *      to the macro.
         * @returns {object} The processed template snippet to be included in the processed stack
         *      template.
         */
        Transform: function(macroName, parameters) {
            return {
                "Fn::Transform" : {
                    "Name" : macroName,
         ...
         *      to `false`.
         */
        If: function(conditionName, valueIfTrue, valueIfFalse) {
            return {
