// Documentation, which is taken from the AWS documentation, last updated 2019-03-15

/**
 * @file Provides functions which represent CloudFormation's [intrinsic functions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference.html).
 */

/**
 * Coerce a value into the expected type based on its usage.
 */
